...
**[School Library]**Is an application to record what books are in the OOP University library and who borrows them.
...
```sh
  cd my-folder
  git clone https://github.com/ONJoseph/school-library.git
```
